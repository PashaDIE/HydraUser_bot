...
CMD_HELP.update({
    ...
    \n\n`•CMD: .ange`\
    \n•Penjelasan: Ketik Ini Kalo Lu Lagi Sange\
    \n\n`•CMD: .lopu`\
    \n•Penjelasan: Nyatakan Cinta Ke Cewe Orng\
    \n\n`•CMD: .hujan`\
    \n•Penjelasan: Penyesalan Seorang Laki-laki Yang Diulangin Terus Menerus`\
    \n\n`•CMD: .dahlah`\
    \n•Penjelasan: Cek Aja dh sndri\
    \n\n`•CMD: .jawa`\
